...
$clientId = "700677004046";			//Merchant Id defined by bank to user
$amount = "2";					//Transaction amount
$oid = "";							//Order Id. Must be unique. If left blank, system will generate a unique one.

$okUrl = "https://ahlanantalya.com.tr/payment/p/3DPayHostingResultPage.php";		//URL which client be redirected if authentication is successful
$failUrl = "https://ahlanantalya.com.tr/payment/p/3DPayHostingResultPage.php";	//URL which client be redirected if authentication is not successful
...
?>
    <form method="post" action="https://spos.isbank.com.tr/fim/est3Dgate">
    <center>
        <h1>
