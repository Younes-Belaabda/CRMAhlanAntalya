...
@section('sub_title','View Data Cash')
@section('content')
    @push('panel_css')
    @endpush
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Cash Info') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{ Route('panel.cash.add_new' , @$data->income_id ) }}" method="POST" role="form text-left">
                  @csrf
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="@error('date')border border-danger rounded-3 @enderror">
                                    <input name="date" class="form-control datepicker"  autocomplete="off" type="text" placeholder="Date" required
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="@error('for_id') border border-danger rounded-3 @enderror">
                                    ...
                                    <option value="">Choose</option>
                                    <option value="0" {{ isset($data->for_id) && $data->for_id == "0" ? 'selected' : '' }}>Expenses</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('type') border border-danger rounded-3 @enderror">
                                    <select name="type" class="select form-control" id="type" required>
                                        ...
                                        <option value="Expenses" {{ isset($data->type) && $data->type == "Expenses" ? 'selected' : '' }}>Expenses</option>
                                    </select>
                                </div>
                            </div>
                        </div>
