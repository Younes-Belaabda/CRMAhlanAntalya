...
<head>
    ...
    <style>
        ...
        @media(max-width:772px) {
            ...
            div#exp_pdf>table:first-child thead,
            div#exp_pdf>table:first-child thead tr,
            div#exp_pdf>table:first-child thead tr th {
            ...
            table.bt tfoot th:first-child::after,
            table.bt tfoot td:first-child::after,
            table.bt tbody td:first-child::after {
                display: none;
            }

            table.bt tfoot th::after,
            table.bt tfoot td::after,
            table.bt tbody td::after,
            ...
            table.bt tfoot th.commission::after,
            table.bt tfoot td.commission::after,
            ...
            .card .actable th,
            .card .actable td,
            .card .actable th:first-child,
            .card .actable td:first-child,
            .card td.incs,
            .card table.table.act th:last-child,
            .card table.table.act td:last-child {
                width: 100% !important;
            }
            ...
            table.table thead th p.showmobile,
            .showmobile {
                display: inline-block;
            }
            ...
            table.table.nopadhid tbody td p,
            table.table.nopadhid thead th p {
                display: inline-block;
            }
