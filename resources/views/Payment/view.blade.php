...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/style.css?v=0.1') }}">
    ...
    <meta itemprop="image" content="{{ asset('public/bg2.jpeg') }}" />
    ...
    <meta property="og:image" content="{{ asset('public/bg2.jpeg') }}" />
    ...
    <div class="wrapper" id="app" style="background-image: url({{ admin_url(setting('bg_image_payment_page')) }})">
        ...
        <div class="card-form">
            ...
            <div class="card-form__inner">
                ...
                ?>
                <form id="payment-form" action="{{ route('payments.pay', [$type, $price]) }}" method="post">
                    @csrf
                    <div class="card-input">
                        <label for="cardNumber" class="card-input__label">Card Number</label>
                        <input type="text" id="cardNumber" required name="pan" class="card-input__input"
                    ...
                    <div class="card-input">
                        ...
                        <input type="text" id="cardName" required name="holder" class="card-input__input"
                            v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName"
                            autocomplete="off">
                    </div>
                    <div class="card-form__row">
                        <div class="card-form__col">
                            <div class="card-form__group">
                                ...
                                <select class="card-input__input -select" name="Ecom_Payment_Card_ExpDate_Month"
                                    id="cardMonth" v-model="cardMonth" v-on:focus="focusInput" v-on:blur="blurInput"
                                    data-ref="cardDate">
                                ...
                                <select class="card-input__input -select" name="Ecom_Payment_Card_ExpDate_Year"
                                    id="cardYear" v-model="cardYear" v-on:focus="focusInput" v-on:blur="blurInput"
                                    data-ref="cardDate">
                        ...
                        <div class="card-form__col -cvv">
                            <div class="card-input">
                                ...
                                <input type="text" class="card-input__input" id="cardCvv" v-mask="'####'"
                                    name="cv2" maxlength="4" v-model="cardCvv" v-on:focus="flipCard(true)"
                    ...
                    <div class="card-form__row">
                        <div class="card-form__col">
                            <div class="card-input">
                                ...
                                <input type="text" required class="card-input__input" readonly
                        ...
                        <div class="card-form__col">
                            <div class="card-input">
                                ...
                                <select name="cur" id="cur" class="card-input__input" required disabled>
                                    ...
                                    <option value="978" <?php echo $currencyVal == 978 ? 'selected' : ''; ?>>Euro</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    $show = true;
                    if ($amount != null) {
                        echo '<button id="btn-pay" type="submit" class="card-form__button">Pay</button>';
                    }
                    ?>
                </form>
            </div>
