...
$clientId = "400888878";			//Merchant Id defined by bank to user
$amount = "9.95";					//Transaction amount
$oid = "";							//Order Id. Must be unique. If left blank, system will generate a unique one.

$okUrl = "https://sanalpos.teb.com.tr/fim/est3dteststoreutf8?pagelang=en";		//URL which client be redirected if authentication is successful
$failUrl = "https://sanalpos.teb.com.tr/fim/est3dteststoreutf8?pagelang=en";	//URL which client be redirected if authentication is not successful

$rnd = microtime();				//A random number, such as date/time
$currencyVal = "949";			//Currency code, 949 for TL, ISO_4217 standard
$storekey = "Erkan7087596";		//Store key value, defined by bank.
