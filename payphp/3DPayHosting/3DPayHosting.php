...
$clientId = "700655000100";			//Merchant Id defined by bank to user
$amount = "9.95";					//Transaction amount
$oid = "";							//Order Id. Must be unique. If left blank, system will generate a unique one.

$okUrl = "https://ahlanantalya.com.tr/payphp/3DPayHosting/3DPayHostingResultPage.php";		//URL which client be redirected if authentication is successful
$failUrl = "https://ahlanantalya.com.tr/payphp/3DPayHosting/3DPayHostingResultPage.php";	//URL which client be redirected if authentication is not successful

$rnd = microtime();				//A random number, such as date/time
$currencyVal = "949";			//Currency code, 949 for TL, ISO_4217 standard
$storekey = "TRPS1234";			//Store key value, defined by bank.
