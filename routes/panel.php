...
Route::group(['prefix' => '/', 'middleware' => ['auth']], function(){
    ...
    Route::group(['middleware' => ['IsAdmin']], function(){
        ...
        Route::prefix('settings')->group(function () {
            Route::get('/' , [\App\Http\Controllers\Panel\SettingController::class , 'index'])->name('settings');
            Route::post('/update' , [\App\Http\Controllers\Panel\SettingController::class , 'update'])->name('settings.update');
        });
